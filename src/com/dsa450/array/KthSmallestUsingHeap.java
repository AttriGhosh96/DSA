...
//creating a min heap and returning the minimum element k times. Complexity= O(n+klogn), where n is for formation of heap
...
public class KthSmallestUsingHeap {
    ...
    public static void main(String[] args) {
        ...
        int k=3;
        int minimumAtEachCall = Integer.MAX_VALUE;
        int maxCapacity = arr.length;
        MinHeap minHeap = new MinHeap(maxCapacity);
        ...
        for(int j=1; j<=k; j++)
        {
            minimumAtEachCall = minHeap.getMinimum();
        }
        System.out.println("The " +k + "th smallest element: " +minimumAtEachCall);
    }
}
